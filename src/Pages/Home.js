        ...
        <div className='col-md-12 second-section'>
            <div className='container d-flex second-sec-content'>
                    ...
                    <div className='col-md-4'>
                        ...
                        <p className='sec-paragraph'> Maxime mollitia,
...
numquam blanditiis harum quisquam eius sed odit fugiat iusto fuga praesentium</p>
        ...
        <div className='col-md-12 third-section'>
          ...
          <div>&nbsp;</div>
            <div className='container third-sec-container'>
                 <p className=''><span>1.</span> Create An Account</p>
                 <p><span>2.</span> Invite Supporters To Yor Page</p>
                 <p><span>3.</span> Start receiving payments</p>
            </div> 
        </div>
        <div className='col-md-12 forth-section'>
            <div className='container forth-sec-content'>
                      <div className='col-md-6 forth-cont-paragraph'>
                          <p className=''><span>1.</span>create an account</p> 
                          <p className=''><span>2.</span>Invite Supporters to your page</p>
                          <p className=''><span>3.</span>Start receiving payments</p>
        ...
        <div style={{height: "150px"}} className='col-md-12'>
        </div>
        <div style={{background: "#F5F5F5"}}  className='col-md-12 fift-section'>
            <div className='container fift-section-cont'>
                 <div>
                   <p className='fift-section-p'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod <br />tempor incididunt ut labore</p>
                 </div>
                 <div>
        ...
        <div className='col-md-12 sixth-section'>
            <div style={{borderBottom: "1px solid gray", fontWeight: "700"}} className='container pt-1 my-5'>
                 <div className='d-flex justify-content-between sixth-sec'>
                   <p className=''>Mobile App</p>
                   <p className=''>Community</p>
                   <p className=''>Company</p>
                   <p style={{fontWeight: "200", fontSize: "1.5 rem"}} className=''>Photo</p>
            ...
            <div className='container my-5'>
              <p className='' style={{textAlign: "center"}}><span>&copy;</span> Photo, Inc. 2019. We love our users</p>
            </div>
        </div>
    </div>
  )
